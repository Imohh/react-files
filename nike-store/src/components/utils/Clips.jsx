...
const Clips = ({ clip, imgsrc }) => {
	return (
		<>
			<div className="
				relative h-28 w-32 rounded-xl overflow-hidden group 
				...
				<img src={imgsrc}
					...
					absolute top-0 left-0 right-0 rounded-xl opacity-100 z-10
				...
				<video
					...
					muted={true}
					playInline={true}
					className="absolute top-11 left-11 lg:top-8 lg:left-9 sm:top-4 sm:left-5 right-0 flex h-full 
					w-full object-cover opacity-0 z-0 group-hover:opacity-100 
					group-hover:z-20 rounded-xl"
				>
